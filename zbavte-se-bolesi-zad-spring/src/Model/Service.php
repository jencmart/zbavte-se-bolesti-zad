...
class Service
{
    ...
    public static function create (int $id, string $name, string $surname, string $role, string $email, string $phone, string $webPage, string $additional, string $sex) : Service {
